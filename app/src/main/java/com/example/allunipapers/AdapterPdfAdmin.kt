...
class AdapterPdfAdmin : RecyclerView.Adapter<AdapterPdfAdmin.HolderPdfAdmin>, Filterable {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): HolderPdfAdmin {
      // bind inflate layout for row pdf admin
    ...
    override fun onBindViewHolder(holder: HolderPdfAdmin, position: Int) {
       // get data set data and etc
        ...
        // handle click show dialog box edit , delete book
        holder.moreBtn.setOnClickListener{
            moreOptionsDialog(model, holder)
        }

        // handle click pdf detail activity
                ...
                if(position== 0 ){
                  ...
                  // edit is clicked
                    ...
                    context.startActivity(intent)
                     ...
                     // delete is clicked   lets create function in my class for the same

                         // show confirmation dialog firest if you need

                     MyApplication.deleteBook(context, bookId,bookUrl,bookUrl)
    ...
    // view holder for row pdf admin.xml
