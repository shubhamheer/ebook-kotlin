...
class RegisterActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //  handle back button click and go back to previous screen
...
//            input data , validate data , create account firebase auth , save user info at firabase realtime db
            validateData()
        }
    ...
    private fun createUserAccount() {
        ...
        firebaseAuth.createUserWithEmailAndPassword(email,password)
            .addOnSuccessListener {
               // account created now add user info into firebase db
                updateUserInfo()
